/**
 * The Croatian payslip field schema — the single source of truth for the analyzer; the bake-off
 * re-exports it (`scripts/bakeoff/field-schema.ts`), so both read one schema, not two that drift.
 *
